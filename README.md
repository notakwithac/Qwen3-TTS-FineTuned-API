# Qwen3-TTS: Production Fine-Tuning Service

<p align="center">
    <img src="https://qianwen-res.oss-cn-beijing.aliyuncs.com/Qwen3-TTS-Repo/qwen3_tts_logo.png" width="400"/>
<p>

> **Note**: This version of Qwen3-TTS has been enhanced for **Production-Grade Fine-Tuning and Inference** with a focus on scalable cloud-storage-first workflows, disk optimization, and secure audio delivery along with API access.

### 🌟 Project Enhancements
*   **Production API Server (FastAPI)**: A robust, concurrent server for both inference and fine-tuning jobs.
*   **Cloud Storage-First Architecture**: Native integration with E2E Object Storage (S3) for dataset retrieval and audio segment delivery.
*   **Disk LRU & Space Optimization**: Smartly manages a **50GB disk constraint** by offloading models to S3 and using an LRU (Least Recently Used) cache to prune local files.
*   **Secure Delivery (Presigned URLs)**: Automatically generates 24h Presigned URLs for secure playback from private storage.
*   **Hierarchical Organization**: Built-in support for structured pathing: `audio/segments/{book_id}/{chapter_id}/`.
*   **GPU Safety**: Integrated semaphore-based concurrency control to prevent VRAM overflows during heavy usage.

---

We release **Qwen3-TTS**, a series of powerful speech generation capabilities developed by Qwen...
